#!/usr/bin/env python3
"""Update database with verified Alabama websites from CSV"""
...
def update_websites_from_csv(csv_file: str, confidence: float = 1.0, source: str = 'manual_verification'):
    ...
    print("════════════════════════════════════════════════════════════════════")
    print("UPDATE AL WEBSITES FROM CSV")
    print("════════════════════════════════════════════════════════════════════\n")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python update_al_websites_from_csv.py <csv_file> [confidence] [source]")
        print("\nExample:")
        print("  python update_al_websites_from_csv.py al_website_lookup.csv 1.0 manual_verification")
        sys.exit(1)
